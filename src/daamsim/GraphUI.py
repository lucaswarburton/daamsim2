...
class GMUIFrame(Frame):
    def __init__(self, master = None, cnf = {}, background = "white", bd = 2, bg = "white", border = 0, borderwidth = 0, class_ = "Frame", colormap = "", container = False, cursor = "", height = 0, highlightbackground = "grey", highlightcolor = "white", highlightthickness = 0, name = "graphs", padx = 0, pady = 0, relief = "flat", takefocus = 0, visual = "", width = 0):
