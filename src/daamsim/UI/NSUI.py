...
class new_sim_UI_inner_frame(Frame):
    ...
    def setup_rpas(self, i):
        ...
        self.labels["min_rpas_speed"] = Label(self, text = "Minimum RPAS Speed (Inclusive):", bg=self.bg)
        ...
        self.labels["max_rpas_speed"] = Label(self, text = "Maximum RPAS Speed (Inclusive):", bg=self.bg)
        ...
        self.labels["rpas_speed_interval"] = Label(self, text = "RPAS Speed Array Interval:", bg=self.bg)
        ...
        self.labels["custom_rpas_speed_array"] = Label(self, text = "RPAS Speed Custom Array:", bg=self.bg)
